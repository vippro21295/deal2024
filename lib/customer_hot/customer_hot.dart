...
class CustomerHot extends StatefulWidget {
  final String username;
  const CustomerHot({super.key, required this.username});

  @override
  State<CustomerHot> createState() => _CustomerHotState();
}
    ...
    if (response.statusCode == 200) {
      ...
      if (data["isError"] == false) {
        Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => CreateAppoinmentResult(
                    userName: widget.username,
                    objectCus: item,
                    lastAppointmentResult: data["obj"])));
      }
    }
  }
              ...
              actions: [
                IconButton(
                  ...
                  icon: const Icon(Icons.add,
                      color: Color.fromARGB(255, 8, 142, 1)),
                ),
                IconButton(
