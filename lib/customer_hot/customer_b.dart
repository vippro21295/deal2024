...
class CustomerBuy extends StatefulWidget {
  ...
  const CustomerBuy({super.key, required this.username});

  @override
  State<CustomerBuy> createState() => _CustomerBuyState();
}

class _CustomerBuyState extends State<CustomerBuy> {
  late Future<List<dynamic>> _dataFuture;
  DateTime fromDate = DateTime.now().add(const Duration(days: -1));
  DateTime toDate = DateTime.now();
  String? selectedType = '';
  TextEditingController searchController = TextEditingController();
  String title = 'Khách hàng đã mua xe';
