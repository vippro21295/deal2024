...
class DenyBuyMotor extends StatefulWidget {
  ...
  @override
  State<DenyBuyMotor> createState() => _DenyBuyMotorState();
}

class _DenyBuyMotorState extends State<DenyBuyMotor> {
    ...
    if (validateSubmit()) {
      ...
      if (response.statusCode == 200) {
        ...
        if (data["isError"] == false) {
          ...
          Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=> CustomerHot(username: widget.username)));
        } else {
