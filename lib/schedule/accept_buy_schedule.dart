...
class AcceptBuySchedule extends StatefulWidget {
  final dynamic objCustomer;
  final String username;
  const AcceptBuySchedule(
      {super.key, required this.objCustomer, required this.username});

  @override
  State<AcceptBuySchedule> createState() => _AcceptBuyScheduleState();
}

class _AcceptBuyScheduleState extends State<AcceptBuySchedule> {
